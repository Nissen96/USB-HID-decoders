...
Moves and clicks can optionally be animated by adding an animation speed with `--speed [1-10]`. Animation can be paused and resumed with `<SPACE>` and quitted by pressing `q`.
